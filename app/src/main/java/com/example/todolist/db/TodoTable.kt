...
//objects are singleton classes in Kotlin
//inside object only static object can exist
...
object TodoTable {
    ...
    fun getAllTodos(db: SQLiteDatabase): ArrayList<Todo> {
        ...
        var cursor = db.query(TABLE_NAME,arrayOf(Columns.ID,Columns.TASK,Columns.DONE),null,null,null,null,null)
